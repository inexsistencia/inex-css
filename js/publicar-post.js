$(function(){
      ...
      reader.onload = (function(theFile) {
        return function(e) {
         ...
         var foto = document.createElement('span');
          ...
          document.getElementById('list-agregar').insertBefore(foto);
  ...
  document.getElementById('files-agregar').addEventListener('change', agregar_img_prev, false);

  function edit_img_prev(evt) {
    var files = evt.target.files; // FileList object
      ...
      reader.onload = (function(theFile) {
        return function(e) {
         ...
         var foto = document.createElement('span');
          foto.innerHTML = ['<img class="thumb" src="', e.target.result,
                            '" title="', escape(theFile.name), '"/>'].join('');
          document.getElementById('list-editar').insertBefore(foto);
  ...
  document.getElementById('files-editar').addEventListener('change', edit_img_prev, false);
